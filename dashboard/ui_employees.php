<?php
	...
	//get number of rows
	$queryNum = $db_connect->query("SELECT COUNT(*) as postNum FROM emp WHERE status = 'UI'");
...
?>
	<section class="side-menu fixed left">
		...
		<ul class="nav">
			...
			<li class="nav-item current"><a href="../dashboard/ui_employees.php"><span class="nav-icon"><i class="fa fa-user"></i></span>UI Employees</a></li>
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper employee_list clearfix">
				<div class="section_title">UI dept. Employees</div>
				<div class="top-bar">
					<div class="top-item">
				...
				<?php
					$getemp = mysqli_query($db_connect, "SELECT * FROM emp WHERE status = 'UI' ORDER BY id ASC");
