<?php
    ...
    if($action == "allemployee"){    
        ...
        //get number of rows
        $queryNum = $db_connect->query("SELECT COUNT(*) as postNum FROM emp ".$whereSQL.$orderSQL);
        ...
        //get rows
        $queryNum = mysqli_query($db_connect, "SELECT * FROM emp $whereSQL $orderSQL LIMIT $start, $limit");
