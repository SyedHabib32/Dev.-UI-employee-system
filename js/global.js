$(document).ready(function(){
    ...
    */
    $("#addemployee").submit(function(e){
    	...
    	if($(".idnumber").val() == ""){
    		IDnumbererror = "Please enter CNIC number";
    	} else {
    		IDnumbererror = "";
    	}
    	...
    	if($(".kinphone").val() == ""){
    		kinphoneerror = "Please enter phone number";
    	...
    	if($(".kinresaddress").val() == ""){
    		kinresaddresserror = "Please enter Residential Address";
    	} else {
    		kinresaddresserror = "";
    	}

    	if($(".kinresdirection").val() == ""){
    		kinresdirectionerror = "Please enter phone number";
    	} else {
    		kinresdirectionerror = "";
    	}
